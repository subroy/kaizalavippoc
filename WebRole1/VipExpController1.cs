...
namespace WebRole1.Controller
{
    public class VipExpController : ApiController
    {
        ...
        public HttpResponseMessage VerifyIP([FromBody]VerifyIPRequest request)
        {
            ...
            HttpResponseMessage response = GetWebRoleResponse();
        ...
        private HttpResponseMessage GetWebRoleResponse()
        {
            ...
            try
            {
                HttpWebRequest resolveip = (HttpWebRequest)WebRequest.Create("https://vipexpfuncapp.azurewebsites.net/api/HttpTriggerCSharp1?code=O6lgafxO6kJxThk0Id52cw2QfdrA8HYTaQYo0IXyZuIVBl4/maKG4g==");
